...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "/alert <code>adresse</code> <code>prix</code> — Alerte de prix\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "/close <code>id</code> — Fermer une position manuellement\n"
        "/alert <code>adresse</code> <code>prix</code> — Créer une alerte prix\n"
        "/alerts — Voir les alertes actives\n"
        "/blacklist — Tokens en blacklist\n"
